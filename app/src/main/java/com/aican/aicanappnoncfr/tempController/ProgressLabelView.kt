...
class ProgressLabelView @JvmOverloads constructor(
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.ProgressLabelView)
        try{
            suffix = typedArray.getString(R.styleable.ProgressLabelView_suffix)?:suffix
            maxValueString = "300$suffix"
        }finally {
            typedArray.recycle()
        }
    }
