package com.aican.aicanappnoncfr.ph
...
class PHCircleView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private fun drawScale(canvas: Canvas) {
        ...
        if (vertical) {
            canvas.drawCircle(center_x, center_y, radius, scalePaint)
        } else {
