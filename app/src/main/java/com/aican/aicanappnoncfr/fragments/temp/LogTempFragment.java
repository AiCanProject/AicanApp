...
import com.aican.aicanappnoncfr.adapters.LogAdapter;
...
public class LogTempFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_log_temp, container, false);
    }
  ...
  /*  private void fetch_logs() {
        ...
        deviceRef.child("Data").child("TEMP_VAL").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                LogTempFragment.this.temp = String.format(Locale.UK, "%.2f", temp);
            }
