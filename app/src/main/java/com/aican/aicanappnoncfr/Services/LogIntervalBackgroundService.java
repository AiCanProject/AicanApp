...
public class LogIntervalBackgroundService extends Service {
...
//                                }
//                            });
                            Log.d("Interval Data 10s", "data interval");
                            ...
                            if (ph == null || temp == null || mv == null) {
                                ...
                                dbHelper.print_insert_log_data(date, time, ph, temp, batchnum, arnum, compound_name);
                                dbHelper.insert_log_data(date, time, ph, temp, batchnum, arnum, compound_name);
                                Toast.makeText(getApplicationContext(), "BG Interval Service data", Toast.LENGTH_SHORT).show();
                            }
