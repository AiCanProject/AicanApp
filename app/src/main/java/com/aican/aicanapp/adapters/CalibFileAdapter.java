...
public class CalibFileAdapter extends RecyclerView.Adapter<CalibFileAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CalibFileAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/LabApp/CalibrationData/CalibrationData.pdf";
