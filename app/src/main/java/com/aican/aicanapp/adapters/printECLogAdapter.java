...
public class printECLogAdapter extends RecyclerView.Adapter<printECLogAdapter.ViewHolder>{
    ...
    public printECLogAdapter(Context context, File[] files) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new printECLogAdapter.ViewHolder(view);
    }

    public void onBindViewHolder(@NonNull printECLogAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/LabApp/ECLogDetails/"+selectedFile.getName();
